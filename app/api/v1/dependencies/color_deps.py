...
__all__ = ['get_color_by_id_from_path', 'get_color_by_id_from_query']

model = models.Color
crud_repo = crud.color
id_param_description = 'The UUID id of the color measurement'
