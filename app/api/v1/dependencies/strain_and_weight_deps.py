...
__all__ = ['get_saw_by_id_from_path', 'get_saw_by_id_from_query']

model = models.StrainAndWeight
crud_repo = crud.strain_and_weight
id_param_description = 'The UUID id of the SAW measurement'
