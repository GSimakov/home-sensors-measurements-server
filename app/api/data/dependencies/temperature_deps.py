...
__all__ = ['get_temperature_by_id_from_path', 'get_temperature_by_id_from_query']

model = models.Temperature
crud_repo = crud.temperature
id_param_description = 'The UUID id of the temperature measurement'
...
async def get_temperature_by_id_from_path(
        id: Annotated[UUID, Path(description=id_param_description)]
) -> model:
    return await get(id=id)


async def get_temperature_by_id_from_query(
